...
<body>
	<form action="memJoin.mem" method="post" name="frm">
		...
		<table border = 1 align="center">
			...
			<tr><td>비밀번호 확인</td>
			<td>
				<input type="password" name="memPwCon">
			</td></tr>
			<tr><td>이름</td>
			<td>
			...
			<tr><td>이메일 수신여부</td>
			<td>
				<input type="radio" name="memEmailCk" value="Y" checked>예
...
<!-- MEM_ID MEM_PW MEM_ADDRESS MEM_NAME MEM_PHONE MEM_BIRTH MEM_GENDER 
MEM_ACCOUNT MEM_EMAIL MEM_EMAIL_CK POST_NUMBER DETAIL_ADD -->